 ...
 * Copyright 2017-2026 Jean-Sebastien Morisset (https://wpsso.com/)
 */
...
if ( ! class_exists( 'WpssoUlRegister' ) ) {
	...
	class WpssoUlRegister {
		...
		public function __construct() {
			...
			//register_deactivation_hook( WPSSOUL_FILEPATH, array( $this, 'network_deactivate' ) );
		...
		private function activate_plugin() {
			...
			if ( class_exists( 'WpssoUtilReg' ) ) {
				...
				$version = WpssoUlConfig::get_version();

				WpssoUtilReg::update_ext_version( 'wpssoul', $version );
			}
		}
