...
_x( 'WPSSO Core add-on to add a user locale (language / region) drop-down menu in the WordPress admin back-end and front-end toolbar.', 'plugin description', 'wpsso-user-locale' );
